"use client"
import { Navbar, Dropdown, Label, TextInput, MegaMenu, DarkThemeToggle } from "flowbite-react";
...
const MegaMenuHeader: FC = function () {
  return (
    <header>
      ...
      <MegaMenu className="border-y py-0 border-gray-200 dark:border-gray-600">
        <div className="grid grid-cols-1 py-3 w-full justify-between items-center lg:grid-cols-2">
          <Navbar.Collapse>
          <Navbar.Link className="[&_span]:hover:text-primary-600 [&_span]:dark:hover:text-primary-500">
              <MegaMenu.Toggle className="dark:!text-white">
                Personal
                <svg
          ...
          <form className="flex mb-4 lg:order-2 lg:mb-0">
            ...
            {/* <Dropdown
              ...
              theme={{
                floating: {
                  target:
                    "hidden lg:block rounded-r-none border w-42 bg-gray-100 border-r-0 border-gray-200 text-gray-900 hover:bg-gray-200 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-800 [&>span]:justify-center flex-shrink-0 justify-center",
                },
                content: "py-1 focus:outline-none bg-primary-500",
              }}
            >
            ...
            <div className="relative w-full">
              <TextInput
                ...
                required
                className="lg:[&_input]:rounded-l-none [&_input]:dark:bg-gray-800"
              />
              <button
                type="submit"
                className="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-primary-700 rounded-r-lg border-0 border-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
        ...
        <MegaMenu.Collapse>
          <div className="-mx-4 grid py-4 px-4 text-gray-900 dark:text-white  md:grid-cols-2 lg:grid-cols-4 md:px-6 dark:border-gray-600">
            <ul className="col-span-2 md:col-span-1">
              <li>
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold">Home Improvements</div>
              ...
              <li>
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold">Motoring</div>
                    <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                    <a href="#" className="hover:text-primary-400">
                      Buy
                    </a>
            ...
            <ul className="col-span-2 md:col-span-1">
              ...
              <li>
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold">Health &amp; Beauty</div>
                    <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                      <a href="#" className="hover:text-primary-400">
                        Dental Implants
                      </a>
